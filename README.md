...
<body>
  ...
  <div class="menu-table flex-row-space-between">
    ...
    <div class="menu-items flex-row-center flex-item">
      ...
      <a href="widgets.html" class="menu-widget">Widgets</a>
      <a href="embedding.html" class="menu-embedding">Embedding</a>
        ...
        <div class="flex-row">
          <div class="flex-item flex-column">
            ...
            <div class="control-group">
              ...
              <a class="custom-button" target="_blank" href="https://code-projects.org" target="_blank">Hyperlink</a>
            ...
            <div class="control-group">
              ...
              <a class="custom-button-flat" href="https://code-projects.org" target="_blank">
